...
import com.phaiecobyte.portfolio_api.module.portfolio.service.impl.ReferenceServiceImpl;
...
public class ReferenceController {
    private final ReferenceServiceImpl service;
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestBody Reference req){
        return ResponseEntity.ok(service.create(req));
    }

    @PutMapping("{id}")
    public ResponseEntity<Object> update(@PathVariable long id,
                                         @RequestBody Reference req){
