package com.phaiecobyte.portfolio_api.module.media.service.impl;
...
import com.phaiecobyte.portfolio_api.module.media.repository.MediaRepository;
import com.phaiecobyte.portfolio_api.module.media.service.MediaService;
import com.phaiecobyte.portfolio_api.module.media.service.MediaStorage;
...
import static com.phaiecobyte.portfolio_api.common.Constants.*;
...
public class MediaServiceImpl implements MediaService {
    ...
    public MediaFile getById(UUID id) {
        return repository.findMediaFileByIdAndStatus(id,STATUS_ACTIVE)
                .orElseThrow(() ->
                        new AppException("Media not found: " + id));
    }
